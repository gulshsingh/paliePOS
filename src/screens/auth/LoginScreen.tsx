        ...
        <ScrollView
          ...
          <View style={[
            ...
            <MaterialCommunityIcons
              ...
              color={errors.email ? theme.colors.danger : focusedField === 'email' ? theme.colors.primary : theme.colors.textMuted}
          ...
          <View style={[
            ...
            <MaterialCommunityIcons
              ...
              color={errors.password ? theme.colors.danger : focusedField === 'password' ? theme.colors.primary : theme.colors.textMuted}
              style={styles.inputIcon}
            />
            <TextInput
              style={styles.input}
...
const styles = StyleSheet.create({
  ...
  logoWrap:       { width: 72, height: 72, borderRadius: 36, backgroundColor: 'rgba(255,255,255,0.2)', justifyContent: 'center', alignItems: 'center', marginBottom: 14 },
  brand:          { fontSize: 32, fontWeight: '900', color: '#fff', letterSpacing: 8 },
  tagline:        { fontSize: 13, color: 'rgba(255,255,255,0.8)', marginTop: 4, letterSpacing: 1 },
  ...
  subheading:     { fontSize: 14, color: theme.colors.textMuted, marginTop: 4, marginBottom: 24 },
  errorBox:       { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: theme.colors.dangerLight, borderRadius: theme.radius.sm, paddingHorizontal: 14, paddingVertical: 10, marginBottom: 16, borderLeftWidth: 3, borderLeftColor: theme.colors.danger },
  errorBoxText:   { color: theme.colors.danger, fontSize: 13, flex: 1 },
  label:          { fontSize: 13, fontWeight: '700', color: theme.colors.textSecondary, marginBottom: 6, letterSpacing: 0.3 },
  inputRow:       { flexDirection: 'row', alignItems: 'center', backgroundColor: theme.colors.surfaceSecondary, borderRadius: theme.radius.md, borderWidth: 1.5, borderColor: theme.colors.border, paddingHorizontal: 14, marginBottom: 4 },
  ...
  eyeBtn:         { padding: 4 },
  fieldError:     { color: theme.colors.danger, fontSize: 11, fontWeight: '600', marginBottom: 12, marginTop: 2 },
  forgotBtn:      { alignSelf: 'flex-end', marginBottom: 24, marginTop: 4 },
  forgotText:     { color: theme.colors.primary, fontSize: 13, fontWeight: '700' },
  button:         { backgroundColor: theme.colors.primary, paddingVertical: 16, borderRadius: theme.radius.md, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, ...theme.shadow.lg },
  buttonDisabled: { opacity: 0.7 },
  buttonText:     { color: '#fff', fontSize: 16, fontWeight: '800', letterSpacing: 0.5 },
  version:        { textAlign: 'center', color: theme.colors.textMuted, fontSize: 12, marginTop: 32 },
});
