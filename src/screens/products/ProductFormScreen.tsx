...
import { productSchema, ProductFormData } from '../../schemas/products/productSchema';
...
export default function ProductFormScreen() {
  ...
  const [isRawMaterial, setIsRawMaterial] = useState(product?.is_raw_material ?? false);
    ...
    <KeyboardAvoidingView
      ...
      <ScrollView
        ...
        <View style={styles.card}>
          ...
          {field('name', 'Product Name *', name, (v) => { setName(v); setErrors((p) => ({ ...p, name: undefined })); }, { placeholder: 'e.g. Veg Pizza' })}
        ...
        <View style={styles.card}>
          <View style={styles.cardHeader}>
            <MaterialCommunityIcons name="database-outline" size={16} color={theme.colors.primary} />
          ...
          <View style={styles.chipRow}>
            <TouchableOpacity
              ...
              <Text style={[styles.chipText, !isRawMaterial && styles.chipTextActive]}>Finished Good</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[styles.chip, isRawMaterial && styles.chipActive]}
              onPress={() => setIsRawMaterial(true)}>
              <Text style={[styles.chipText, isRawMaterial && styles.chipTextActive]}>Raw Material</Text>
            </TouchableOpacity>
          </View>
        ...
        <View style={styles.card}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} nestedScrollEnabled style={styles.chipScroll}>
            <View style={styles.chipRow}>
              <TouchableOpacity
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} nestedScrollEnabled style={styles.chipScroll}>
            <View style={styles.chipRow}>
              <TouchableOpacity
                ...
                onPress={() => setUnitId('')}>
                <Text style={[styles.chipText, !unitId && styles.chipTextActive]}>None</Text>
              </TouchableOpacity>
              {units.map((u: any) => (
                <TouchableOpacity
                  key={u.id}
                  ...
                  <Text style={[styles.chipText, unitId === u.id && styles.chipTextActive]}>
                    {u.name}
                    {u.symbol ? ` (${u.symbol})` : ''}
                  </Text>
                </TouchableOpacity>
