...
const AVATAR_COLORS = [
  '#FFDDD2', '#D2F4FF', '#D2FFE8', '#F4D2FF',
  '#FFECD2', '#D2E4FF', '#FFD2D2', '#D2FFD8',
];
    ...
    <TouchableOpacity
      ...
      {item.phone ? (
        <View style={styles.metaRow}>
          <MaterialCommunityIcons name="phone-outline" size={11} color={theme.colors.textMuted} />
          <Text style={styles.metaText} numberOfLines={1}>{item.phone}</Text>
        </View>
      ) : (
      ...
      <View style={styles.editBadge}>
        <MaterialCommunityIcons name="pencil-outline" size={12} color={theme.colors.primary} />
    ...
    <View style={styles.container}>
      ...
      {isError ? (
        <View style={styles.center}>
          <MaterialCommunityIcons name="wifi-off" size={40} color={theme.colors.textMuted} />
          <Text style={styles.emptyTitle}>Failed to load</Text>
          <Text style={styles.emptySubtitle}>Check your connection and retry</Text>
        </View>
      ) : isLoading ? (
        <FlatList
          data={[1, 2, 3, 4, 5, 6]}
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.center}>
              <MaterialCommunityIcons name="account-group-outline" size={52} color={theme.colors.textMuted} />
              <Text style={styles.emptyTitle}>No customers yet</Text>
              <Text style={styles.emptySubtitle}>Tap Add to create your first customer</Text>
            </View>
          }
          removeClippedSubviews={true}
          maxToRenderPerBatch={10}
